...
from html_sanitization.decorate import decorate_h1, decorate_h2, decorate_h3, decorate_h4, decorate_h5, decorate_h6, decorate_li
from html_sanitization.functions import document_regex, element_regex, extract_strings, get_attribute_value, process_element, remove_element, unwrap_element, unwrap_table, wrap_strings
from utils.regexes import compile
from utils.fsys import make_paths, remove_paths


def html_conf(resources, tqdm_conf, **kwargs):
    inputs = {
        ...
        'sanitizer_conf': {
            'local_functions': [
                ...
                process_element(lambda e: isinstance(e, Tag) and e.name == 'table', unwrap_table),
            ],
